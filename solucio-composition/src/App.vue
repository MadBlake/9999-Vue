  ...
  <div class="layout">
    <aside class="sidebar">
      <div class="sidebar-brand">
        <span style="color:#42b883">⚡</span> Composition API
      </div>
      <nav>
...
.sidebar { width: 260px; flex-shrink: 0; background: #1a1a2e; color: white; overflow-y: auto; height: 100vh; position: sticky; top: 0; }
.sidebar-brand { padding: 16px; font-weight: 700; font-size: 1rem; color: #42b883; border-bottom: 1px solid #333; }
.home-link { display: block; padding: 8px 16px; color: #aaa; text-decoration: none; font-size: 0.88rem; margin-bottom: 4px; }
.home-link:hover { color: white; }
.home-link.router-link-active { color: #42b883; }
.grup { margin-bottom: 4px; }
.grup-titol { padding: 8px 16px; font-size: 0.72rem; font-weight: 700; text-transform: uppercase; color: #888; letter-spacing: 0.5px; border-left: 3px solid #42b883; margin-top: 8px; }
.ex-link { display: flex; align-items: center; gap: 8px; padding: 5px 16px; color: #aaa; text-decoration: none; font-size: 0.82rem; }
.ex-link:hover { color: white; background: #ffffff10; }
.ex-link.router-link-active { color: white; background: #42b88320; }
.ex-num { font-size: 0.68rem; font-weight: 700; color: white; border-radius: 4px; padding: 1px 5px; flex-shrink: 0; }
...
.page .card { background: white; border: 1px solid #e0e0e0; border-radius: 10px; padding: 20px; margin-bottom: 14px; }
.page button { background: #42b883; color: white; border: none; border-radius: 6px; padding: 8px 18px; cursor: pointer; font-size: 0.9rem; font-weight: 600; }
.page button:hover { opacity: 0.85; }
.page button:disabled { background: #ccc; cursor: not-allowed; opacity: 1; }
.page input, .page select, .page textarea { border: 1px solid #ccc; border-radius: 6px; padding: 7px 10px; font-size: 0.9rem; }
.page input:focus, .page select:focus, .page textarea:focus { outline: 2px solid #42b883; border-color: #42b883; }
</style>
